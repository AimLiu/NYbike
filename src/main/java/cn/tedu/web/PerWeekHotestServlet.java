...
/**
 * @author Aim_Liu
 * @create 2021-07-21-10:37
 */
@WebServlet("/history/weekhot")
public class PerWeekHotestServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        //调用业务层
        DistributeVO distributeVO = histryService.findHotestStationByWeek(week);
        //结果转为json格式
        //输出测试
